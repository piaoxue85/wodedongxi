    ...
    try
      ...
      try
        ...
        begin
          ...
          res:=db.ExecuteSql('delete tb_stock_job_done where what_done=''RQAlphaKdjWM''',false,ire , resmsg);
        end;
...
begin
  ...
  sql := 'select code    ,                                              '+
         '       content ,                                              '+
         '       to_char(shi_jian,''yyyymmddhh24miss'') shi_jian        '+
         ' from tb_stock_found_rqalpha order by code ';
  ...
  begin
    ...
    begin
      ...
      res := db.ExecuteSql(sql , false , ire , presmsg) ;
      pResList.Add(db.RS.Fields['code'].Value + '             ' + db.RS.Fields['content'].Value + '             ' +db.RS.Fields['shi_jian'].Value + '             ' +  '');
