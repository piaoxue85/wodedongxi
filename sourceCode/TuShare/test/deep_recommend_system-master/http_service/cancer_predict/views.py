...
class PredictService(object):
    ...
    def init_session_handler(self):
        ...
        if ckpt and ckpt.model_checkpoint_path:
            ...
            print(tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='inputs'))
...
checkpoint_file = "../cnn_checkpoint/checkpoint.ckpt-10.meta"

# checkpoint_path = "D:\Projects\j金融\g股票数据分析系统\sourceCode\TuShare\test\deep_recommend_system-master\checkpoint"
# checkpoint_file = "D:\Projects\j金融\g股票数据分析系统\sourceCode\TuShare\test\deep_recommend_system-master\checkpoint\checkpoint.ckpt-10.meta"
