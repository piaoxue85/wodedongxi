...
def get_data(train_begin="",train_end="", test_begin="", test_end=""):
    train_data = gsd.get_101_data_train1_my_f(start=train_begin, end = train_end)
    test_data  = gsd.get_101_data_test1_my_f (start=test_begin , end = test_end )
...
#     xlf.fit(train_x, train_y, eval_metric='mae', verbose = True, eval_set = [(test_x, test_y)],early_stopping_rounds=50)
