...
# df_sh = ['002106','300387','000768','603019','600020','600000']
df_sh = ['600000']
...
retT = []
for ishare in df_sh:    
    df = gsd.get_stock_data_daily_df_time(ishare,start='2013-01-01' , end='2017-04-06')
...
with tf.Session() as sess:
    ...
    for step in range(1):
        for i in range(int(len(fac)/batch_size)):
            ...
            #print(batch_x.shape)
            #print(batch_y.shape)
            result = sess.run(test_Y_pred,feed_dict={x:batch_x,y:batch_y})
            print("pre_y = " )
            print( result )         
            print("org_y = " )
            print( batch_y )    
