...
# rqalpha run -f Z:\StockAnalysis\sourceCode\TuShare\test\src\importAlpha101_xgb_rqalpha_backtest.py -d z:\rqalpha\bundle -s 2017-01-01 -e 2017-09-22 -o result.pkl --plot --progress --account stock 400000 --benchmark 000016.XSHG
...
def handle_bar(context, bar_dict):
    ...
    print("now:" + today )
    for i in range(0,2):
        codelist,buy_list,returns = xgb.get_buy_list(today=today , buy_count = context.buy_count)
